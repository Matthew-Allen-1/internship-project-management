...
export default function Task(props){
  ...
  return(
    <div className="created-task">
      <input className="input" defaultValue={props.task.title} value = {props.task.title} type="text" />
      <ul>
        <li>{props.task.groupTitle}</li>
      </ul>
      <span className="line-divider"></span>
      <div className="time">
        <input defaultValue = {props.task.startTime} value = {props.task.startTime} type="time" />
        <div className="time-divider">-</div>
        <input defaultValue = {props.task.endTime} type="time" />
      </div>
      <input className="date" type="date" defaultValue= {props.task.date} value = {props.task.date}/>
      <span className="line-divider"></span>
